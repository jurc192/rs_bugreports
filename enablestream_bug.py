...
config   = rs.config()
# config.enable_stream(rs.stream.depth, 0, 848, 480, rs.format.z16, 15) # works
# config.enable_stream(rs.stream.depth, 0)                              # works
...
# config.enable_stream(rs.stream.depth, 0, rs.format.z16, 15)           # can't resolve
